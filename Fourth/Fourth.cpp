...
int main(void)
{
	...
	Shader modelShader("../Common/Shaders/Model.vs", "../Common/Shaders/Model.fs");
	...
	Model cube("../Common/models/piano/piano.obj");

	cout << cube.getNumTrianglesOfMesh(0) << endl;
	//for (int meshes = 0; meshes < cube.getNumOfMeshes(); meshes++)
	//{
	//	int numTriangles = cube.getNumTrianglesOfMesh(meshes);
	//	for (int i=0;i<numTriangles;++i)
	//	{
	//		float* triPoint[3];
	//		for (int j=0;j<3;j++)
	//		{
	//			triPoint[j] = cube.getVertex(meshes, 3 * i + j);
	//		}
	//	}
	//}
	...
	do {
		...
		modelMatrix = glm::scale(glm::translate(modelMatrix, glm::vec3(0, -0.5, 0)), glm::vec3(0.1));
