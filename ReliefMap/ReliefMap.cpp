// ReliefMap.cpp : Defines the entry point for the console application.
//
...
int main(void)
{
	...
	Shader reliefShader("../Common/Shaders/relief.vs", "../Common/Shaders/relief.fs");
	Shader skyboxShader("../Common/Shaders/skybox.vs", "../Common/Shaders/skybox.fs");


	GLuint diffuseMap = loadTexture("../Common/images/grid.png");
	GLuint heightMap = loadTexture("../Common/images/height_1.jpg");
	GLuint normalMap = loadTexture("../Common/images/normal_1.jpg");

	reliefShader.Use();
	glUniform1i(glGetUniformLocation(reliefShader.Program, "diffuseMap"), 0);
	glUniform1i(glGetUniformLocation(reliefShader.Program, "normalMap"), 1);
	glUniform1i(glGetUniformLocation(reliefShader.Program, "depthMap"), 2);
	...
	do {
		...
		GLint modelLoc = glGetUniformLocation(reliefShader.Program, "model");
		GLint viewLoc = glGetUniformLocation(reliefShader.Program, "view");
		GLint projLoc = glGetUniformLocation(reliefShader.Program, "projection");

		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(modelMatrix));
		glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(viewMatrix));
		glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projectionMatrix));
		glUniform3fv(glGetUniformLocation(reliefShader.Program, "lightPos"), 1, glm::value_ptr(pointLightPositions[3]));
		glUniform3fv(glGetUniformLocation(reliefShader.Program, "viewPos"), 1, glm::value_ptr(camera.Position));
		glUniform1f(glGetUniformLocation(reliefShader.Program, "height_scale"), heigth_scale);
